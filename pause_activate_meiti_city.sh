...
CODE_DIR=$AUTO_DATA_NODIST
 ...
 # 结果文件
 target_filename=$TARGET_DIR/report.region.pause_activate_meiti_city.csv
 # 字典表文
...
awk -F\| '{  
                ...
                {
                      arr_index=proviceno"|"appcode"|"servicecode"|"userid
                      p[arr_index]=1
  ...
  awk -F\| '{
               ...
               {
                   proviceName=$1;appcode=$2;activate_num=$5;pause_num=$6;action_str=$7
                   servicename=app[$2]
                   indexstr=proviceName","appcode","servicename
                   p[indexstr]=1
                ...
                str1="激活用户数"
                str2="暂停用户数"
                str3="省编码,地市编码,省名称,地市名称,APPCODE,杂志名称,激活请求次数,暂停请求次数"
