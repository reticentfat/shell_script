...
ipp (){
  ...
  while read a
  do
  sring=`curl -s "http://api.ip138.com/query/?ip=${a}&datatype=txt&token=400316d95aeca0d5706064f0a02456e1"`
...
-i)
shift
sring=`curl -s "http://api.ip138.com/query/?ip=${1}&datatype=txt&token=400316d95aeca0d5706064f0a02456e1"`
echo "$sring " | tee -a ip-result2.txt
;;
*)
echo "[Help]
