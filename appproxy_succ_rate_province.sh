...
DATA_FILE=$TARGET_DIR/appproxy_fengtai_province.txt
RESULT_FILE=$REPORT_DIR/report.region.appproxy_succ_rate_province.csv
PROXY_CODE=$CODE_DIR/proxy_error_code.txt    #请求结果错误代码
NODIST_CITY=$CODE_DIR/nodist_city.txt

bzcat $AUTO_SRC_DATA/$V_DATE/appproxy.log.fengtai.log.$V_DATE.bz2 |grep 'BIP2B247,' > $DATA_FILE
